...
public class TradeLogic_8 : TradeLogic
{
    ...
    public override List<TradeOrder> GetBuyOrders(IReadOnlyList<Candlestick> iPastHourly, double iCurrentPrice, Decision iDecision)
    {
        ...
        {
            var multiplier = Utils.Lerp(1.0, quantityBlendFinalWeight, (double)Mathf.Clamp((float)((historicStdDev-quantityBlendStartStd) / (quantityBlendEndStd - quantityBlendStartStd)), 0.0f, 1.0f));
