...
/// <summary> 
/// Same as TradeLogic_4, but all orders takes profit above (below) first order.
/// </summary>
public class TradeLogic_5 : TradeLogic
{
    ...
    public TradeLogic_5(string iVariation)
        : base(new TradeLogicInfo("TradeLogic_5", iVariation))
    {
